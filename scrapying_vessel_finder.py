...
# 定义保存和加载进度的函数
def save_progress(current_url, page, flag_index, type_value,num_csv,scrapying_page_num,filename='progress.json'):
    progress_data = {
...
def boat_info_analysis(url):
    global page, flag_index, type_value,num_csv,scrapying_page_num
    try:
        ...
        save_progress(url, page, flag_index, type_value, num_csv,scrapying_page_num,progress_filename)
        raise e
...
if progress_data:
    ...
    print(f"Resuming from {current_url}")
